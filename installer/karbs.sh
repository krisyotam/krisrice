...
rssurls="$(cat <<'EOF'
https://krisyotam.com/rss.xml "~Kris Yotam"
https://videos.krisyotam.com/feeds/videos.xml?videoChannelId=1 "~Kris Yotam (Videos)"
https://www.youtube.com/feeds/videos.xml?channel_id=UC2eYFnH61tmytImy1mTYvhA "~Kris Yotam (YouTube)"
EOF
)"
...
welcomemsg() {
	whiptail --title "Welcome!" \
		--msgbox "Welcome to Kris's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-Kris" 10 60
...
# Ensure newsboat urls file exists and append feeds if it does
if [ -s "/home/$name/.config/newsboat/urls" ]; then
    echo "$rssurls" | sudo -u "$name" tee -a "/home/$name/.config/newsboat/urls" >/dev/null
else
